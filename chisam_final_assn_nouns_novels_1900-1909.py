...
def nouns():
    """
    Generates the nouns from a text in a corpus.
...
path = "/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/novels_1900-09/*.txt"
...
texts = [[word.strip(punctuations) for word in document.split() if word in nouns]for document in documents]
...
dictionary.save("/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/practicenovel.dict")
...
corpora.MmCorpus.serialize('/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/corpusnovel.mm', corpus)  # store to disk, for later use
print corpus[:10]
...
if (os.path.exists('/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/practicenovel.dict')):
    dictionary = corpora.Dictionary.load('/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/practicenovel.dict')
    corpus = corpora.MmCorpus("/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/corpusnovel.mm")
...
user_text_choice = "The-Crisis.txt"#"To-Have-And-To-Hold.txt"

fn = "/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/novels_1900-09/"+user_text_choice
doc = open(fn, 'r').read()
...
# for index, t in enumerate(tuplee):
#     if(index % 2 == 0):
#         p2tf.append(t)
#     else:
#         p1tf.append(t)
