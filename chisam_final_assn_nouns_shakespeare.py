...
dictionary.save("/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/practice.dict")
...
corpora.MmCorpus.serialize('/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/corpus.mm', corpus)  # store to disk, for later use
print corpus[:10]
...
if (os.path.exists('/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/practice.dict')):
    dictionary = corpora.Dictionary.load('/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/practice.dict')
    corpus = corpora.MmCorpus("/Users/jordanchisam/Desktop/ProgrammingTextAnalysis/corpora/corpus.mm")
